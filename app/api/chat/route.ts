...
// Utility to remove unsupported keys
...
`
    ...
    const cleanMessages = sanitizeMessages(messages.slice(-3))
    console.log("Final sanitized messages sent to Groq:", JSON.stringify(cleanMessages, null, 2))
