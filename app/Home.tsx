...
import { ShoppingBag, Truck, Shield, RotateCcw, ArrowRight, GraduationCap } from "lucide-react"
      ...
      <div className="bg-gradient-to-r from-blue-600 to-purple-700 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          <div className="text-center">
            <h1 className="text-4xl md:text-6xl font-bold mb-6">Premium Healthcare Products & Courses</h1>
            <p className="text-xl md:text-2xl mb-8 text-blue-100 max-w-3xl mx-auto">
              Discover our comprehensive range of high-quality healthcare solutions and educational courses designed to
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              We're committed to providing the best healthcare products and educational content with exceptional service
            </p>
          </div>
      ...
      <div className="bg-gray-900 text-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
            Browse our extensive catalog of healthcare products and educational courses
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/products">
